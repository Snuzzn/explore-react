    ...
    <>
      <DemoCont>
        ...
        <UnstyledBtn onClick={() => fetchPokemon()}>
          <img src="/images/pokeball.png" width="60px" />
        </UnstyledBtn>
        <History>
          {[...Array(3).keys()].map((key, ind) => (
            <MiniPokemon key={ind}>
              <motion.img
