...
const ListRendering = () => {
  return (
    <>
      ...
      <InfoCard>
        We can use the <InlineCode>map</InlineCode> array method to render a
        list. Make sure to include a unique key for each item, to give it a
        stable identity. This is especially important if the array is updated.
      </InfoCard>
      <Codeblock
